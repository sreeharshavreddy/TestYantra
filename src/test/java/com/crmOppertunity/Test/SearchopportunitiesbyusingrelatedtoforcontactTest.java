...
public class  SearchopportunitiesbyusingrelatedtoforcontactTest {
	
   @Test
  public void  searchopportunitiesbyusingrelatedtoforcontact() throws Throwable
	{
		// generate random number
		 ...
		 FileInputStream fs = new FileInputStream(".\\src\\test\\resources\\TestData.xlsx");
          ...
          driver.findElement(By.linkText("Opportunities")).click();
           ...
           sel2.selectByVisibleText("before");
           driver.findElement(By.xpath("//table[@class='searchUIAdv3 small']//input[1]")).click();
      }
	}
